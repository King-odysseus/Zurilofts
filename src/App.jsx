...
const HostApplicationPage = lazy(
  () => import("./pages/HostApplicationPage.jsx"),
);
const IdentityVerificationPage = lazy(
  () => import("./pages/IdentityVerificationPage.jsx"),
);
...
const ShortlistDetailPage = lazy(
  () => import("./pages/ShortlistDetailPage.jsx"),
);
const SharedShortlistPage = lazy(
  () => import("./pages/SharedShortlistPage.jsx"),
);
...
const AdminHostApplications = lazy(
  () => import("./pages/AdminHostApplications.jsx"),
);
const AdminIdentityVerifications = lazy(
  () => import("./pages/AdminIdentityVerifications.jsx"),
);
