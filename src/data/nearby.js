...
export const PLACES_TO_VISIT = [
  ...
  { name: 'Nairobi Street Kitchen', area: 'westlands', category: 'entertainment', lat: -1.2638, lng: 36.8005, desc: 'A vibrant weekend food and art market in Westlands bringing together local chefs, artists, and live music — perfect for a relaxed Saturday afternoon.', image: '/images/place-nairobi-street-kitchen.jpg' },
  ...
  { name: 'The Hub Karen', area: 'karen', category: 'shopping', lat: -1.3700, lng: 36.7230, desc: 'An upscale open-air shopping mall with boutique stores, artisanal cafés, and a relaxing atmosphere that blends modern retail with Karen\'s leafy charm.', image: '/images/place-hub-karen.jpg' },
  { name: 'UN Headquarters Nairobi', area: 'gigiri', category: 'culture', lat: -1.2306, lng: 36.8144, desc: 'The global United Nations campus set in lush gardens. Guided tours are available, and the compound hosts regular cultural and environmental events.', image: '/images/place-un-hq.jpg' },
  ...
  { name: 'The Lavington Green', area: 'lavington', category: 'shopping', lat: -1.2845, lng: 36.7720, desc: 'A charming shopping and dining centre set in Lavington\'s leafy neighbourhood. Great for brunch, groceries, and boutique shopping.', image: '/images/place-lavington-green.jpg' },
  { name: 'Lavington Curve', area: 'lavington', category: 'entertainment', lat: -1.2810, lng: 36.7685, desc: 'A modern strip mall with top-tier restaurants, a health club, and lifestyle stores — a favourite meeting spot for Lavington residents.', image: '/images/place-lavington-curve.jpg' },
