...
function PropertyCard({ property }) {
  ...
  return (
    <div className="group shadow-sm hover:shadow-lg transition-shadow transition-all duration-300 hover:-translate-y-2 overflow-hidden h-full flex flex-col">
      {/* Image */}
      <div className="relative aspect-[4/3] overflow-hidden flex-shrink-0">
        {image ? (
          <img src={image} alt={title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
        ) : (
          <div className="w-full h-full bg-[#D9D9D9]/30 flex items-center justify-center">
