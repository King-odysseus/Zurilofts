      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-semibold text-[#222222] mb-1">Not found</h3>
          ...
          <>
                ...
                {shortlist.items.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.id}
                      to={`/property/${p.id}`}
                      className="group block bg-white rounded-[14px] overflow-hidden shadow-md hover:shadow-lg transition-all duration-200"
                    >
                      <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="flex-1 p-4 flex flex-col justify-center min-w-0">
                          <h3 className="text-sm font-semibold text-[#222222] group-hover:text-[#2563EB] transition-colors line-clamp-1">
                            {p.title}
                          </h3>
                          ...
                          <p className="text-sm font-semibold text-[#222222] mt-2">
            ...
            <div className="mt-12 pt-6 border-t border-[#E5E7EB] text-center">
              <p className="text-xs text-[#6b7280]">
                Created with{" "}
                <Link to="/" className="text-[#2563EB] hover:text-[#1D4ED8] font-medium transition-colors">
                  ZuriLofts
                </Link>
