...
import { getEditorialGuide } from "../data/guides.js";
...
function GuideDetailPage() {
  ...
  useEffect(() => {
    ...
    apiClient
      ...
      .catch(() => {
        const editorialGuide = getEditorialGuide(slug);
        if (editorialGuide) setPost(editorialGuide);
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="pt-24 pb-16 flex items-center justify-center min-h-[60vh]">
          <div className="text-center max-w-md px-6">
            ...
            <Link
              to="/guides"
              className="inline-block min-h-[44px] bg-[#C49A6C] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#B8895C] transition-all duration-200"
            >
              Browse Guides
            </Link>
          </div>
