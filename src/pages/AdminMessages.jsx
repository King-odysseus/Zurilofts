...
function AdminMessages() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden grid grid-cols-1 md:grid-cols-3 min-h-[60vh]">
        {/* Conversation list */}
          ...
          {loadingList ? (
            ...
            conversations.map((c) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 border-b border-[#D9D9D9] hover:bg-canvas transition-colors ${
            ...
            <>
              ...
              <form onSubmit={handleReply} className="p-3 border-t border-[#D9D9D9] flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-[#C49A6C]/40 text-sm bg-white text-[#1f2937]"
                />
                <button
                  type="submit"
