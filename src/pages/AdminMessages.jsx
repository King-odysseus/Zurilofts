            ...
            conversations.map((c) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-[#222222] text-sm">{c.firstName} {c.lastName}</span>
                  {c.unread > 0 && (
          ...
          {!activeUser ? (
            ...
            <>
              <div className="px-4 py-3 border-b border-[#E5E7EB]">
                <p className="font-semibold text-[#222222] text-sm">{activeUser.firstName} {activeUser.lastName}</p>
              ...
              <form onSubmit={handleReply} className="p-3 border-t border-[#E5E7EB] flex gap-2">
                <input
                  value={body}
