        ...
        <div className="w-full mx-auto px-5 md:px-8 lg:px-12 xl:px-16 max-w-screen-2xl">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
              ...
              {/* Coming Soon cards — show only when no real listings exist on default view */}
              {!loading && listings.length === 0 && filter === 'all' && priceRange === 'all' && !availableOnly && [18, 16, 15, 14].map((imgIndex) => (
